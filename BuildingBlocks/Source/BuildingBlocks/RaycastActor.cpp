...
ARaycastActor::ARaycastActor()
{
	...
	//Get input component from player to avoid memory acess violation
	// https://answers.unrealengine.com/questions/218218/how-to-get-inputcomponent-in-c.html  ->possible solution
	

	//Memory acess violation, missing Uin
	//player->InputComponent->BindAction("Raycast_Button", IE_Pressed, this, &ARaycastActor::RayCast);
